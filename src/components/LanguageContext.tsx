...
const translations = {
    tr: {
        ...
        'chat.title': 'Wois AI Eğitmeni',
        'chat.subtitle': 'Notlarınız üzerinden derinlemesine öğrenin.',
        'chat.select_context': 'Kaynak Seç',
        'chat.no_context': 'Henüz kaynak seçilmedi',
        'chat.placeholder': 'Sorunuzu buraya yazın...',
        'chat.send': 'Sor',
        'chat.modal_title': 'Ders Kaynaklarını Seç',
        'chat.modal_desc': 'AI\'nın hangi notlar üzerinden konuşmasını istersiniz?',
    },
    en: {
        'nav.dashboard': 'Dashboard',
        ...
        'chat.title': 'Wois AI Tutor',
        'chat.subtitle': 'Learn deeply from your notes.',
        'chat.select_context': 'Select Source',
        'chat.no_context': 'No source selected',
        'chat.placeholder': 'Type your message...',
        'chat.send': 'Ask',
        'chat.modal_title': 'Select Lesson Sources',
        'chat.modal_desc': 'Which notes should the AI discuss?',
    }
}
